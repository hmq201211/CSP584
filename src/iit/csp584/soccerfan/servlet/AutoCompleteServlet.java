...
import iit.csp584.soccerfan.utility.AjaxUtility;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("lookup")) {
                ...
                ArrayList<Accessory> data = AjaxUtility.getData(searchId);
                if (searchId != null && data != null) {
                    ArrayList<Accessory> a = new ArrayList<>();
                    for (Accessory accessory : data) {
                        if (accessory.getId().equals(searchId))
                            a.add(accessory);
                    }
                    request.setAttribute("list", a);
                    System.out.println(a);
                    RequestDispatcher rd = context.getRequestDispatcher("/WEB-INF/jsp/accessory/accessory_list.jsp");
